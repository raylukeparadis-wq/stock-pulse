        ...
        {!recsLoading && allRecommendations && (
          <div style={{ marginBottom: 24 }}>
            ...
            {(() => {
              ...
              const sellTriggers = trackedPositions.filter(item => item.exitStatus && item.exitStatus.closed);
              const sellWatch = trackedPositions.filter(item => item.exitStatus && !item.exitStatus.closed);
              const categories = {
