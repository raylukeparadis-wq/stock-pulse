                ...
                <div style={{ display: "flex", gap: 12 }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ paddingLeft: 8, marginBottom: 8 }}>
                      <span style={{ fontSize: 12, fontWeight: 600, color: "#94a3b8" }}>Price & 5-Day MA</span>
                      <div style={{ fontSize: 10, color: "#475569" }}>Last 30 sessions</div>
                    </div>
                    <ResponsiveContainer width="100%" height={220}>
                      <LineChart data={priceData} margin={{ left: 4, right: 8 }}>
                        ...
                        <YAxis tick={{ fill: "#475569", fontSize: 10 }} tickLine={false} axisLine={false}
                          domain={["auto", "auto"]} tickFormatter={v => `$${v.toLocaleString()}`} width={60} />
                    ...
                    <div style={{ display: "flex", gap: 12, paddingLeft: 8, paddingTop: 6, flexWrap: "wrap" }}>
                      {[["#3b82f6", "Close"], ["#f59e0b", "5-Day MA"]].map(([c, l]) => (
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ paddingLeft: 8, marginBottom: 8 }}>
                      <span style={{ fontSize: 12, fontWeight: 600, color: "#94a3b8" }}>Today's Price</span>
                      <div style={{ fontSize: 10, color: "#475569" }}>5-min intervals</div>
                    </div>
                    {intradayBars.length === 0 ? (
                      ...
                      <ResponsiveContainer width="100%" height={220}>
                        <LineChart data={intradayBars} margin={{ left: 4, right: 8 }}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#1e293b" />
                    ...
                    <div style={{ display: "flex", gap: 12, paddingLeft: 8, paddingTop: 6 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 10, color: "#64748b" }}>
                        <div style={{ width: 14, height: 2, background: "#22c55e", borderRadius: 2 }} />Today's Close
                      </div>
                    </div>
                  </div>
                </div>
