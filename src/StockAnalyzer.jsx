  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <>
            ...
            <button
              ...
              style={{
                ...
                display: "flex", alignItems: "center", gap: 8, marginBottom: chartExpanded ? 12 : 20,
              }}
            >
              <span style={{ fontSize: 13, fontWeight: 700, color: "#94a3b8" }}>Charts &amp; Signals</span>
        ...
        {!recsLoading && allRecommendations && (allRecommendations.longWatch?.length > 0 || allRecommendations.paperPortfolio?.holdings?.length > 0 || allRecommendations.paperPortfolio?.closedHistory?.length > 0) && (
